...
const userController = {
    ...
    getUser: async (req, res) => {
        try {
            ...
            res.status(500).json({
                msg: "Lấy thông tin người dùng theo ID thất bại",
                error: e.message,
            });
            console.log("Lấy thông tin người dùng theo ID thất bại", e.message);
        }
    },
    updateUser: async (req, res) => {
        try {
            ...
            res.status(500).json({
                msg: "Cập nhật thông tin người dùng thất bại",
                error: e.message,
            });
            console.log("Cập nhật thông tin người dùng thất bại", e.message);
        }
    }
};
